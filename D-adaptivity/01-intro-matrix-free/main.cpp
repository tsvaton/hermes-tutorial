...
int main(int argc, char* argv[])
{
  ...
  do
  {
    ...
    if (as > 1)
    {
      Hermes::Mixins::Loggable::static_info("Transferring previous fine mesh solution to new fine mesh.");
    ...
    Hermes::Mixins::Loggable::static_info("Performing JFNK on new fine mesh.");
    try
    {
    ...
    Hermes::Mixins::Loggable::static_info("Projecting fine mesh solution to coarse mesh.");
