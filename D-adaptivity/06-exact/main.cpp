...
int main(int argc, char* argv[])
{
  ...
  do
  {
    ...
    Hermes::Mixins::Loggable::static_info("Assigning f() to the fine mesh.");
    ...
    Hermes::Mixins::Loggable::static_info("Calculating exact error."); 
    ...
    // Report results.
    Hermes::Mixins::Loggable::static_info("ndof_coarse: %d, ndof_fine: %d, err_exact_rel: %g%%", 
